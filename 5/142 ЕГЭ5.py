'''(№ 142) На вход алгоритма подаётся натуральное число N. Алгоритм строит по нему новое число R следующим образом.
...
for n in range(65):
    b = bin(n)[2:]  # перевод в 2 систему, отрезаем 2 первых символа
    # print(b)
    if b.count('1') % 2 == 0:  # если количество 1 четно
        b += '0'
    else:
        b += '1'
    if b.count('1') % 2 == 0:  # если количество 1 четно
        ...
        b += '1'
    r = int(b, 2)  # перевод в целое число из 2 системы
    if r > 43:
        print(r)
        break
